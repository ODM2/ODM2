Emilio's [PRISM](http://nvs.nanoos.org/CruisePrism)-XAN Data Use Case. XAN (the database model) stands for [Xenia](http://code.google.com/p/xenia/wiki/XeniaHome) Adaptation to [NANOOS](http://www.nanoos.org/).
