"""
Summary: Load data from a WaterML 1.1 file retrieved from a CUAHSI HIS
WaterOneFlow web service into an ODM2 SQLite database

Created by: Jeff Horsburgh
Created on: 11-13-2014
Modified on: 3-3-2016
...
# url = 'http://data.iutahepscor.org/loganriverwof/cuahsi_1_1.asmx?WSDL'     # Alternative WOF 1.1 URL
...
# FeatureGeometry = NULL (to keep it simple, I'm using the FeatureGeometryWKT field)
...
samplingFeatureInfo = (str(uuid.uuid1()),
                       ...
                       'Point',
                       'POINT (' + str(valuesResult.timeSeries[0].sourceInfo.geoLocation.geogLocation.longitude) + ' ' +
                       str(valuesResult.timeSeries[0].sourceInfo.geoLocation.geogLocation.latitude) + ')',
